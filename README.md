...
MEMBROS DA EQUIPE: ROGÉRIO CORRÊA DE CAMPOS - MATRÍCULA: 26180315, MATHEUS RAUPP DE MELO - MATRÍCULA: 26104502, LUCAS GARCIA VIEIRO - MATRÍCULA: 26103977
...
C) IMAGEM DO DIAGRAMA DE CLASSES E EXPLICAÇÃO DAS CLASSES E COMPOSIÇÃO ENTRE ELAS

![Diagrama](Diagramadeclasses)
...
* Revisão do código para entender se alguma funcionalidade ou arquitetura poderia ser melhorada.
...
* Classe Pessoa;
* Método de compatibilidade (funcionalidade inovadora).

Matheus:

* Classe Endereco;
* Menu de interação da Main;
